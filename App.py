...
if st.session_state.form_submitted:
    ...
    st.button("💬 Ask AI About Your Resume", on_click=lambda: st.session_state.update({"chat_mode": True}))
...
if st.session_state.chat_mode:
    ...
    user_q = st.text_input("Ask anything about your resume:")
    ...
    if user_q:
        ...
        Give clear, practical improvement advice.
        """
